...
XXXXXXX, _______, _______, _______, MS_WHLD, DF(0)  , XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, _______, QK_BOOT, XXXXXXX,
                  XXXXXXX, XXXXXXX, _______, _______, _______, _______, _______, _______, XXXXXXX, XXXXXXX
),
    [_NAV] = LAYOUT( // nav
XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
XXXXXXX, _______, C(KC_W), PRETAB , NEXTAB , WINTAB ,                   KC_HOME, KC_PGUP, KC_END , _______, _______, XXXXXXX,
XXXXXXX, OS_G   , C(KC_R), C(KC_S), C(KC_E), CSP    ,                   KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT, _______, XXXXXXX,
XXXXXXX, C(KC_Z), _______, _______, KC_F5  , _______, XXXXXXX, XXXXXXX, KC_DEL , KC_PGDN, KC_INS , _______, _______, XXXXXXX,
                  XXXXXXX, XXXXXXX, _______, _______, _______, KC_RSFT, _______, _______, XXXXXXX, XXXXXXX
),
    [_SYM] = LAYOUT( // right 
XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
XXXXXXX, KC_EXLM, KC_AT  , KC_ASTR, KC_COLN, KC_EQL ,                   KC_UNDS, KC_LCBR, KC_RCBR, KC_QUOT, KC_PIPE, XXXXXXX,
XXXXXXX, OS_G   , OS_A   , OS_C   , OS_S   , KC_MINS,                   KC_HASH, KC_LPRN, KC_RPRN, KC_DQUO, KC_DLR , XXXXXXX,
XXXXXXX, KC_CIRC, KC_AMPR, KC_PERC, KC_BSLS, KC_SLSH, XXXXXXX, XXXXXXX, KC_TILD, KC_LBRC, KC_RBRC, KC_GRV , _______, XXXXXXX,
                  XXXXXXX, XXXXXXX, _______, _______, _______, _______, _______, _______, XXXXXXX, XXXXXXX
),
    [_FUN] = LAYOUT(
XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
XXXXXXX, _______, KC_F1  , KC_F2  , KC_F3  , KC_F10 ,                   _______, P2     , P1     , DF(1)  , _______, XXXXXXX,
XXXXXXX, _______, KC_F4  , KC_F5  , KC_F6  , KC_F11 ,                   KC_F2  , KC_F5  , KC_F12 , DF(0)  , _______, XXXXXXX,
XXXXXXX, _______, KC_F7  , KC_F8  , KC_F9  , KC_F12 , XXXXXXX, XXXXXXX, _______, _______, _______, DF(2)  , _______, XXXXXXX,
                  XXXXXXX, XXXXXXX, _______, _______, _______, _______, _______, _______, XXXXXXX, XXXXXXX
),
    [_NUM] = LAYOUT(
XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
XXXXXXX, _______, _______, _______, KC_ASTR, KC_PLUS,                   KC_0   , KC_1   , KC_2   , KC_3   , KC_PLUS, XXXXXXX,
XXXXXXX, OS_G   , OS_A   , OS_C   , OS_S   , KC_MINS,                   KC_SLSH, KC_4   , KC_5   , KC_6   , KC_MINS, XXXXXXX,
XXXXXXX, _______, _______, _______, CW_TOGG, KC_EQL , XXXXXXX, XXXXXXX, KC_DOT , KC_7   , KC_8   , KC_9   , KC_EQL , XXXXXXX,
...
XXXXXXX, XXXXXXX, MV_LF  , MV_UP  , MV_DN  , MV_RG  ,                   FO_LF  , FO_DN  , FO_UP  , FO_RG  , XXXXXXX, XXXXXXX,
XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, WS_LF  , WS_RG  , WS_TAB , XXXXXXX, XXXXXXX, XXXXXXX,
                  XXXXXXX, XXXXXXX, _______, _______, _______, LALT(KC_SPC), _______, _______, XXXXXXX, XXXXXXX
)
};
